				...
				<div class="login-body">
					...
					<form action="" method="post">
						...
						<div class="mb-20">
                            ...
                            <a href="registration.php" class="font-weight-light"> Create a Librarian </a>
						</div>
                        <div class="login-footer text-center">
                            <div class="separator">
                                <p class="change_link">
                                    <a class="text-right" href="/user/student/login.php">Login as Student</a><br>
                                    <a class="text-right" href="/user/teacher/login.php">Login as Teacher</a>
                                </p>
                        </div>
				        </div>
                        <div class="">
