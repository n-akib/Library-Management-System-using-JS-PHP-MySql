	...
	if (isset($_POST["submit"])) {
        ...
        if(mysqli_num_rows($sql2_u) > 0){
            ...
            if($insert){
                ...
                //echo $mysqli->error;
                echo "We can't send mail because of SMTP error. To verify this account <a href='http://localhost/user/teacher/verify.php?vkey=$vkey'>Click Here</a>. This is for demo purpose only.";
            }
		}
	}
?>